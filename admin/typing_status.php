...
$livehelp_path = '/livehelp/admin/typing_status.php';
...
$query_update_status = "UPDATE " . $table_prefix . "sessions SET support_typing_status = $status WHERE login_id = '$login_id'";
