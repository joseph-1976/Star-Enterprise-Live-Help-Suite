...
if (!isset($_GET['FROM_LOGIN_ID'])){ $_GET['FROM_LOGIN_ID'] = ""; }
...
$query = "INSERT INTO " . $table_prefix . "messages (message_id,from_login_id,to_login_id,message_datetime,message,display_time,display_username,display_align) VALUES('','-1','$to_login_id',NOW(),'$send_message','0','0','2'), ('','-1','$to_login_id',NOW(),'$send_message_close','0','0','2')";
...
header("Location: users.php?REFRESH=$refresh&" . SID);
?>