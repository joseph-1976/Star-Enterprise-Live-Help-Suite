...
?>
<LiveHelp Pending="<?php echo(pendingUsersPopup($popup_timeout)); ?>" Browsing="<?php echo(browsingUsersPopup($popup_timeout)); ?>" Transferred="<?php echo(transferredUsersPopup($popup_timeout)); ?>" TotalPending="<?php echo(totalPendingUsers()); ?>" TotalBrowsing="<?php echo(totalBrowsingUsers()); ?>" />