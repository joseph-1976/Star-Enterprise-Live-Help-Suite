...
$from_login_id = $row['last_login_id'];
...
?>
<SendMessage xmlns="urn:LiveHelp"><?php echo($message_result); ?></SendMessage>
<?php
	exit();
}
...
if ($message != '') {
	...
	$query_insert_result = $SQL->insertquery($query);
	if ($query_insert_result != false) {
		$message_result = "true";
	}
}
