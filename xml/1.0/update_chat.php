...
if ($current_active > 0) { 
	...
	$query_update_status = "UPDATE " . $table_prefix . "sessions SET support_typing_status = $current_typing WHERE login_id = '$current_login_id'";
